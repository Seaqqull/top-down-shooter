...
namespace Kool2Play.Editor.OwnAttribute
{
    ...
    [CustomPropertyDrawer(typeof(Utility.OwnAttribute.EndReadOnlyGroupAttribute))]
    ...
    [CustomPropertyDrawer(typeof(Utility.OwnAttribute.BeginReadOnlyGroupAttribute))]
